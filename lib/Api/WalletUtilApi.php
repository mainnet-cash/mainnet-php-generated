...
class WalletUtilApi
{
    ...
    /**
     * Operation utilGetRawTransaction
     *
     * Get bitcoin raw transaction
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type Request to get raw transaction (required)
     *
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return AnyOfObjectElectrumRawTransaction
     */
    public function utilGetRawTransaction($unknown_base_type)
    {
        list($response) = $this->utilGetRawTransactionWithHttpInfo($unknown_base_type);
        return $response;
    }

    /**
     * Operation utilGetRawTransactionWithHttpInfo
     *
     * Get bitcoin raw transaction
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type Request to get raw transaction (required)
     ...
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of AnyOfObjectElectrumRawTransaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function utilGetRawTransactionWithHttpInfo($unknown_base_type)
    {
        $request = $this->utilGetRawTransactionRequest($unknown_base_type);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('AnyOfObjectElectrumRawTransaction' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'AnyOfObjectElectrumRawTransaction', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = 'AnyOfObjectElectrumRawTransaction';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        'AnyOfObjectElectrumRawTransaction',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation utilGetRawTransactionAsync
     *
     * Get bitcoin raw transaction
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type Request to get raw transaction (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function utilGetRawTransactionAsync($unknown_base_type)
    {
        return $this->utilGetRawTransactionAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation utilGetRawTransactionAsyncWithHttpInfo
     *
     * Get bitcoin raw transaction
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type Request to get raw transaction (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function utilGetRawTransactionAsyncWithHttpInfo($unknown_base_type)
    {
        $returnType = 'AnyOfObjectElectrumRawTransaction';
        $request = $this->utilGetRawTransactionRequest($unknown_base_type);
    ...
    /**
     * Create request for operation 'utilGetRawTransaction'
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type Request to get raw transaction (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function utilGetRawTransactionRequest($unknown_base_type)
    {
        // verify the required parameter 'unknown_base_type' is set
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling utilGetRawTransaction'
            );
        }

        $resourcePath = '/wallet/util/get_raw_transaction';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
