...
class UtilApi
{
     ...
     * @return \Mainnet\Model\ConvertResponse
     */
     ...
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mainnet\Model\ConvertResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function convertWithHttpInfo($convert_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mainnet\Model\ConvertResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Mainnet\Model\ConvertResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Mainnet\Model\ConvertResponse';
            $responseBody = $response->getBody();
     ...
     * convert between units
     *
     * @param  \Mainnet\Model\InlineObject $inline_object inline_object (optional)
     *
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mainnet\Model\InlineResponse200
     */
    public function exchangeRate($inline_object = null)
    {
        list($response) = $this->exchangeRateWithHttpInfo($inline_object);
        return $response;
    }

    /**
     * Operation exchangeRateWithHttpInfo
     *
     * convert between units
     *
     * @param  \Mainnet\Model\InlineObject $inline_object (optional)
     *
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mainnet\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function exchangeRateWithHttpInfo($inline_object = null)
    {
        $request = $this->exchangeRateRequest($inline_object);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mainnet\Model\InlineResponse200' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Mainnet\Model\InlineResponse200', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Mainnet\Model\InlineResponse200';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mainnet\Model\InlineResponse200',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exchangeRateAsync($inline_object = null)
    {
        return $this->exchangeRateAsyncWithHttpInfo($inline_object)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation exchangeRateAsyncWithHttpInfo
     *
     * convert between units
     *
     * @param  \Mainnet\Model\InlineObject $inline_object (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exchangeRateAsyncWithHttpInfo($inline_object = null)
    {
        $returnType = '\Mainnet\Model\InlineResponse200';
        $request = $this->exchangeRateRequest($inline_object);
    ...
    /**
     * Create request for operation 'exchangeRate'
     *
     * @param  \Mainnet\Model\InlineObject $inline_object (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function exchangeRateRequest($inline_object = null)
    {

        $resourcePath = '/util/exchange_rate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
