...
class WalletApi
{
     ...
     *
     * @param  \Mainnet\Model\SendRequest $send_request encode a transaction (required)
     *
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mainnet\Model\EncodeTransactionResponse
     */
    public function encodeTransaction($send_request)
    {
        list($response) = $this->encodeTransactionWithHttpInfo($send_request);
        return $response;
    }
     ...
     */
    public function encodeTransactionWithHttpInfo($send_request)
    {
        $request = $this->encodeTransactionRequest($send_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function encodeTransactionAsync($send_request)
    {
        return $this->encodeTransactionAsyncWithHttpInfo($send_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function encodeTransactionAsyncWithHttpInfo($send_request)
    {
        $returnType = '\Mainnet\Model\EncodeTransactionResponse';
        $request = $this->encodeTransactionRequest($send_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function encodeTransactionRequest($send_request)
    {
        // verify the required parameter 'send_request' is set
        if ($send_request === null || (is_array($send_request) && count($send_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $send_request when calling encodeTransaction'
            );
        }
