 ...
 * @link     https://openapi-generator.tech
 */
class UtxoToken implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Utxo_token';
    ...
    public function setCommitment($commitment)
    {
        if (!is_null($commitment) && (mb_strlen($commitment) > 80)) {
            throw new \InvalidArgumentException('invalid length for $commitment when calling UtxoToken., must be smaller than or equal to 80.');
        }
