...
class TokenSendRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets capability
     *
     * @param string|null $capability Capability of the NFT
     *
     * @return $this
     */
    ...
    public function setCommitment($commitment)
    {
        if (!is_null($commitment) && (mb_strlen($commitment) > 80)) {
            throw new \InvalidArgumentException('invalid length for $commitment when calling TokenSendRequest., must be smaller than or equal to 80.');
        }
