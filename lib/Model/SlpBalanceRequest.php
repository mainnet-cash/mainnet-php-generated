...
/**
 * SlpBalanceRequest Class Doc Comment
 *
 * @category Class
 * @package  Mainnet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SlpBalanceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SlpBalanceRequest';
     ...
     * Sets token_id
     *
     * @param string|null $token_id Full token identifier aka its genesis transaction id
     *
     * @return $this
     */
