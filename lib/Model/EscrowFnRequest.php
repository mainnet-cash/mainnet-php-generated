...
class EscrowFnRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets action
     *
     * @param string|null $action In addition to `send`ing the built transaction, the built transaction hex may be returned (without broadcasting) with `build` action.
     *
     * @return $this
     */
