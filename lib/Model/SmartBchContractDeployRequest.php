...
/**
 * SmartBchContractDeployRequest Class Doc Comment
 *
 * @category Class
 * @package  Mainnet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SmartBchContractDeployRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartBchContractDeployRequest';
     ...
     * Sets script
     *
     * @param string $script solidity source code used to create this contract instance
     *
     * @return $this
     */
