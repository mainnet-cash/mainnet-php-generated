...
/**
 * SlpBalanceResponse Class Doc Comment
 *
 * @category Class
 * @package  Mainnet
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SlpBalanceResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SlpBalanceResponse';
     ...
     * Sets name
     *
     * @param string|null $name Full name of the SLP token
     *
     * @return $this
     */
