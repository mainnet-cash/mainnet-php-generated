 ...
 * @link     https://openapi-generator.tech
 */
class TokenNft implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Token_nft';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['commitment'] === null) {
            $invalidProperties[] = "'commitment' can't be null";
        }
        if ((mb_strlen($this->container['commitment']) > 80)) {
     ...
     * Sets capability
     *
     * @param string $capability Capability of the NFT
     *
     * @return $this
     */
     ...
     * Sets commitment
     *
     * @param string $commitment Token commitment message, hexadecimal encoded, 40 bytes max length
     *
     * @return $this
     */
    public function setCommitment($commitment)
    {
        if ((mb_strlen($commitment) > 80)) {
            throw new \InvalidArgumentException('invalid length for $commitment when calling TokenNft., must be smaller than or equal to 80.');
        }
