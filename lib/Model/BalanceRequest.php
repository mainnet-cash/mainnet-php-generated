 ...
 * @link     https://openapi-generator.tech
 */
class BalanceRequest extends UnitType 
{
     ...
     * Sets wallet_id
     *
     * @param string $wallet_id The walletId to get a balance for.
     *
     * @return $this
     */
     ...
     * Sets slp_aware
     *
     * @param bool|null $slp_aware If you have any SLP tokens on the address, you should set `slpAware` to `true` to prevent accidental token burning This flag activates utxo checking against an external slp indexer So far this option is not switched on by default
     *
     * @return $this
     */
