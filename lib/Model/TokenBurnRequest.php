...
class TokenBurnRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'wallet_id' => 'string',
        'requests' => '\Mainnet\Model\TokenBurnItem[]',
        'message' => 'string'
    ];
     ...
     * Gets requests
     *
     * @return \Mainnet\Model\TokenBurnItem[]
     */
     ...
     * Sets requests
     *
     * @param \Mainnet\Model\TokenBurnItem[] $requests One or more burn requests. Requests can span multiple categories, all burned in a single transaction sharing one OP_RETURN.
     *
     * @return $this
     */
