...
*UtilApi* | [**exchangeRate**](docs/Api/UtilApi.md#exchangerate) | **POST** /util/exchange_rate | convert between units
...
## Documentation For Models
 ...
 - [TokenBurnItem](docs/Model/TokenBurnItem.md)
 - [TokenBurnRequest](docs/Model/TokenBurnRequest.md)
 - [TokenGenesisItem](docs/Model/TokenGenesisItem.md)
 - [TokenGenesisRequest](docs/Model/TokenGenesisRequest.md)
 - [TokenMintItem](docs/Model/TokenMintItem.md)
 - [TokenMintRequest](docs/Model/TokenMintRequest.md)
 - [TokenNft](docs/Model/TokenNft.md)
 ...
 - [WalletNamedExistsResponse](docs/Model/WalletNamedExistsResponse.md)
 - [WalletReplaceNamedRequest](docs/Model/WalletReplaceNamedRequest.md)
 - [WalletReplaceNamedResponse](docs/Model/WalletReplaceNamedResponse.md)
